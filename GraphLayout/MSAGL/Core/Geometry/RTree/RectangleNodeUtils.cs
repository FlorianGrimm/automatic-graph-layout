...
namespace Microsoft.Msagl.Core.Geometry {
    internal sealed class RectangleNodeUtils {
        internal static void CrossRectangleNodes<TA, TB, P>(RectangleNode<TA,P > a, RectangleNode<TB, P> b, Action<TA, TB> action) {
            if (!a.IntenalRectangle.Intersects(b.IntenalRectangle)) {
                return;
            }
                ...
                if (b.Left == null) //b is a leaf                    
{
        ...
        private static bool HandleEqualityCheck<TA,P>(RectangleNode<TA,P> a, Func<TA, TA, bool> func) {
            if (a.Left == null) {
        ...
        private static void HandleEquality<TA,P>(RectangleNode<TA,P> a, Action<TA, TA> action) {
            if (a.Left == null) {
