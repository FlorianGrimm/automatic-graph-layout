...
namespace Microsoft.Msagl.Routing.Visibility {
    ...
    internal class TangentVisibilityGraphCalculator {
        ...
        private void AllocateDataStructures(int i) {
            ...
            this.currentPolygon = this.polygons[i];
        }
        private void Sweep() {
        ...
        /// <param name="e1"></param>
        /// <returns></returns>
        private int TangentComparison(Tangent e0, Tangent e1) {
        ...
        private void OrganizeTangents() {
            foreach (Polygon q in this.polygons) {
                if (q != this.currentPolygon) {
                    this.ProcessPolygonQ(q);
                }
            }

            this.tangents.Sort(new Comparison<Tangent>(this.TangentComparison));
            /////debug
        ...
        private TangentVisibilityGraphCalculator(List<Polygon> holes, VisibilityGraph visibilityGraph, bool useLeftPTangents) {
            this.polygons = holes;
