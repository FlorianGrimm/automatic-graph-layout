    ...
    public class HubRadiiCalculator {
        ...
        internal void CreateNodeRadii() {
            ...
            foreach (var v in this.metroGraphData.VirtualNodes()) {
                v.Radius = 0;
                v.cachedIdealRadius = CalculateIdealHubRadiusWithNeighbors(this.metroGraphData, this.bundlingSettings, v);
                ;
            }
        ...
        /// Grow hubs
        /// </summary>
        private bool GrowHubs(bool useHalfEdgesAsIdealR) {
        ...
        private bool TryGrowHub(Station v, bool useHalfEdgesAsIdealR) {
            double oldR = v.Radius;
            double allowedRadius = this.CalculateAllowedHubRadius(v);
            ...
            double idealR = useHalfEdgesAsIdealR ?
                                  CalculateIdealHubRadiusWithAdjacentEdges(this.bundlingSettings, v) :
                                  v.cachedIdealRadius;
        ...
        private double CalculatePotential(Station v, bool useHalfEdgesAsIdealR) {
            double idealR = useHalfEdgesAsIdealR ?
                            CalculateIdealHubRadiusWithAdjacentEdges(this.bundlingSettings, v) :
                            v.cachedIdealRadius;
        ...
        /// </summary>
        private double CalculateAllowedHubRadius(Station node) {
            double r = this.bundlingSettings.MaxHubRadius;
            ...
            //obstacles
            double minimalDistance = this.metroGraphData.tightIntersections.GetMinimalDistanceToObstacles(node, node.Position, r);
        ...
        /// </summary>
        private static double CalculateIdealHubRadius(MetroGraphData metroGraphData, BundlingSettings bundlingSettings, Station node) {
            double r = 1.0;
            foreach (Station adj in node.Neighbors) {
        ...
        /// Returns the ideal radius of the hub
        /// </summary>
        private static double CalculateIdealHubRadiusWithAdjacentEdges(BundlingSettings bundlingSettings, Station node) {
